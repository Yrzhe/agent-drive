...
| **Scope** | Whatever user approved | MCP defaults to `read:drive write:drive share:create read:memory write:memory path:/`; can be narrowed with `AGENT_TOKEN_SCOPES` |
